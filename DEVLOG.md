...
This edge case regarded nodes that do not have outgoing nodes, and are mentioned in other nodes, ie 'B': [('C', 2)], where B would be considered a key, but C is not included in graph, and therefore might get ignored
